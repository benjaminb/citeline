...
kobayashi = [
    ...
    "Figure 1. Star formation histories (a), age–metallicity relations (b), and MDFs (c) for the models in the solar neighborhood",
    "Figure 2 is the same as Figure 1 but for the bulge, halo, and thick disk models.",
    ...
    "Figure 5. Evolution of the elemental abundances [X/Fe] from C to Zn against [Fe/H] for the models in the solar neighborhood",
    "Figure 6. Same as Figure 3 but the elemental abundances [ X /Fe] from C to Zn",
    "Figure 7. [C/Fe]–[Fe/H] relation for the solar neighborhood models in this paper (solid line) and in K11 (dashed line).",
    "Figure 8. Same as Figure 3 but for [C/O] plotted against [O/H].",
    "Figure 9. Same as Figure 7 , but for [N/Fe]–[Fe/H] relation.",
    "Figure 10. Same as Figure 3 but for the N/O ratio plotted against the oxygen abundance.",
    "Figure 11. Same as Figure 7 , but for the [O/Fe]–[Fe/H] relation.",
    "Figure 12. Same as Figure 7 , but for the [Mg/Fe]–[Fe/H] relation.",
    "Figure 13. Same as Figure 3 but for [Mg/O] against [O/H].",
    "Figure 14. Same as Figure 7 , but for the [Si/Fe]–[Fe/H] relation.",
    "Figure 15. Same as Figure 7 , but for the [S/Fe]–[Fe/H] relation.",
    "Figure 16. Same as Figure 7 , but for the [Ca/Fe]–[Fe/H] relation",
    "Figure 17. Same as Figure 7 , but for the [Na/Fe]–[Fe/H] relation.",
    "Figure 18. Same as Figure 7 , but for the [Al/Fe]–[Fe/H] relation.",
    "Figure 19. Same as Figure 7 , but for the [P/Fe]–[Fe/H] relation.",
    "Figure 20. The [Cu/Fe]–[Fe/H] relation for the solar neighborhood models from this paper (solid line)",
    "Figure 21. Same as Figure 7 , but for the [K/Fe]–[Fe/H] relation.",
    "Figure 22. The [Sc/Fe]–[Fe/H] relation for the solar neighborhood models from this paper (solid line)",
    "Figure 23. Same as Figure 22 , but for the [Ti/Fe]–[Fe/H] relation.",
    ...
    "Figure 28. Same as Figure 22 , but for the [Co i /Fe]–[Fe/H] relation.",
